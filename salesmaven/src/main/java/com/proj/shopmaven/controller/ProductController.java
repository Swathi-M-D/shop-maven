package com.proj.shopmaven.controller;

import com.proj.shopmaven.entity.Product;
import com.proj.shopmaven.entity.User;
import com.proj.shopmaven.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Map<String, Object>> getProducts(
        ...
        try {
            ...
            System.out.println("📥 Controller received user: " + request.getAttribute("authenticatedUser"));
